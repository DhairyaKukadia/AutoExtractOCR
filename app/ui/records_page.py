...
class RecordsPage(QWidget):
    def __init__(self, session, current_user):
        ...
        filters_form.addRow('Sort By', self.sort_by)
        filters_form.addRow('Sort Dir', self.sort_dir)
    ...
    def clear_filters(self):
        ...
        self.sort_by.setCurrentText('created_at')
        self.sort_dir.setCurrentText('desc')
